...
_DEMO_USERS: list[tuple[str, str, str, str, Optional[str]]] = [
    ...
    ("赵伟", "demo.zhaow@futian.gov.cn", "expert", "机关党委(办公室)", "综合事务AI专家"),
    ("钱晓", "demo.qianx@futian.gov.cn", "expert", "法制与政务服务科", "法制政务AI专家"),
    ("孙楠", "demo.sunn@futian.gov.cn", "expert", "房地产与租赁管理科", "房地产与租赁AI专家"),
    ("周燕", "demo.zhouy@futian.gov.cn", "expert", "公共住房建设管理科", "公共住房建设AI专家"),
    ("吴峰", "demo.wuf@futian.gov.cn", "expert", "住房改革与保障科", "住房保障AI专家"),
    ("郑晨", "demo.zhengc@futian.gov.cn", "expert", "建筑业管理科", "建筑业管理AI专家"),
    ("王璐", "demo.wangl@futian.gov.cn", "expert", "房屋安全管理与整治科", "房屋安全AI专家"),
    ("冯磊", "demo.fengl@futian.gov.cn", "expert", "物业监管科", "物业监管AI专家"),
    ("陈瑶", "demo.cheny@futian.gov.cn", "expert", "建设科技与燃气科", "建设科技与燃气AI专家"),
    ("楚天", "demo.chut@futian.gov.cn", "expert", "消防人防管理科", "消防人防AI专家"),
    # 4 member (普通员工)
