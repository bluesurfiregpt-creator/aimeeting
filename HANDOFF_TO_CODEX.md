...
> **本机 repo root**: `/Users/bluesurfire/Documents/claude/aimeeting/`
...
不是 录音工具. 是 "组织决策记忆 + AI 任务执行" 闭环 SaaS. 详 `/Users/bluesurfire/Documents/claude/aimeeting/docs/NORTH_STAR.md` § 1.
...
详 `/Users/bluesurfire/Documents/claude/aimeeting/HANDOFF.md` § 3.1.
...
# 前端 (另一个 terminal)
cd /Users/bluesurfire/Documents/claude/aimeeting/frontend
npm install
...
| # | 文件 | 时间 | 用途 |
|---|------|------|------|
| 1 | `/Users/bluesurfire/Documents/claude/aimeeting/HANDOFF_TO_CODEX.md` | (本文件) | master 索引 + 上手 路径 |
| 2 | `/Users/bluesurfire/Documents/claude/aimeeting/HANDOFF.md` | 5 min | 工程交接 — § 3.1 mock 大头清单 + § 7 风险 + § 11-12 哪些文件最重要 / 不要乱动 |
| 3 | `/Users/bluesurfire/Documents/claude/aimeeting/AGENTS.md` | 5 min | 长期 工作 规则 — 三 token 隔离 / 中文表达 4 条 / Kimi 测试 路径规范 |
| 4 | `/Users/bluesurfire/Documents/claude/aimeeting/SECRETS.md` | 5 min | 服务器 + SSH + 第三方 目录 (无 实际 值) — § 7 拿 真值 流程 |
| 5 | `/Users/bluesurfire/Documents/claude/aimeeting/REQUIREMENTS.md` § 4-7 | 5 min | P0 功能 + 页面职责 + 用户完整 流程 |
| 6 | `/Users/bluesurfire/Documents/claude/aimeeting/DESIGN_NOTES.md` § 7-9 | 5 min | 已实现 / 未实现 / 设计 vs 代码 不一致 |
| 7 | `/Users/bluesurfire/Documents/claude/aimeeting/CLAUDE.md` | 5 min | 历史 守则 (跟 AGENTS.md 一致 留兼容) — 反例 + 触发时机 |

### 4.2 P1 深度 reference (干 saga 时 查)

| 文件 | 用途 |
|------|------|
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/NORTH_STAR.md` | **产品宪法 v1.2.4** (813 行) — § 1.4 / § 3 / § 6 / § 7 / § 8 必读 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/system/DESIGN_SYSTEM.md` | **视觉宪法** (775 行) — § 0.3 三 token 隔离 / § 10 设计 vs 代码 20 处 冲突 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/dev-setup.md` | 启动 / 部署 详细指引 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/PRODUCT_OVERVIEW.md` | 产品 历史 概览 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/SCHEMA-mobile-v2.md` | Mobile V2 API 契约 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/` | 57 个 Kimi 测试用例 (双盲 + 单元), 模板 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/handoffs/` | design bundle 历史 |
| `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/specs/` | saga changelist 历史 |
...
| Web 会议室 (§ 7.1.1 例外) | **MR_TOKENS** (双 theme) | `/Users/bluesurfire/Documents/claude/aimeeting/frontend/src/components/web/meeting-room/tokens.ts` | light default |
| Mobile + 小程序 | **MR_COLORS** (单 theme 浅 iOS) | `/Users/bluesurfire/Documents/claude/aimeeting/frontend/src/components/mobile/meeting-room/styles.ts` | 永远 light |
...
1. 先 读 `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/system/DESIGN_SYSTEM.md`
...
cd /Users/bluesurfire/Documents/claude/aimeeting/frontend && ./node_modules/.bin/tsc --noEmit

# Backend Python syntax
cd /Users/bluesurfire/Documents/claude/aimeeting/backend && python3 -c "import ast, glob; [ast.parse(open(f).read(), filename=f) for f in glob.glob('app/**/*.py', recursive=True)]"
```
...
任何 `feat(*)` / `fix(*)` 落 生产 → 必出 `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/<版本号>-kimi.md`. 顶部 6 条 反幻觉 死规矩 + 唯一账号 + REPO_ROOT.
...
PM 跑 5 个 Kimi 待跑用例 (`/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-*.md`) 验 跨端 GREEN. 你 收 retro.
...
详 `/Users/bluesurfire/Documents/claude/aimeeting/SECRETS.md`. 关键 总结:
...
| **`backend/.env`** 真值 | PM 通过 安全渠道 给 (1password / 私聊), 你 写本机 `/Users/bluesurfire/Documents/claude/aimeeting/backend/.env` 或 SSH 进 server 改 |
| **DB 内 LLM api_key** | server 上 SQL update (不 export 出来), 走 `model_provider_config` 表 |
| **测试 账号 / 密码** | 已 文档化 在 `/Users/bluesurfire/Documents/claude/aimeeting/CLAUDE.md` § 测试账号 (demo 共享, 非 secret) |
...
```
/Users/bluesurfire/Documents/claude/aimeeting/
...
| # | 用例 文件 | 测什么 | 备注 |
|---|---------|--------|------|
| 1 | `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-b-8-kb-fix-round2-kimi.md` | KB hits Round 2 (Lex 12 / Mira 10) | Claude 自测 GREEN, 等 Kimi 跨端 |
| 2 | `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-b-9-new-a-superseded-kimi.md` | NEW-A 简版 conflict_detector | DB 已有 superseded 数据 |
| 3 | `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-c-13-mira-nlu-create-meeting-kimi.md` | Mira NLU + 创会 真接 | Claude 自测 GREEN |
| 4 | `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-c-11-new-a-full-kimi.md` | NEW-A 完整版 撤销 + drawer | ⚠️ 需 PM 重新 触发 conflict 数据 (见 § 2.3 风险 2) |
| 5 | `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-c-10-new-b-topics-kimi.md` | NEW-B 议题主题 + 议题线 DOM | Claude 自测 5/5 GREEN |

第 6 个 `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v1.4.0-phase-c-12-file-preview-kimi.md` 需 PM 先 上传 真 PDF 才能 验.

---

## 11. 数据 模型 速查 (Codex 改 业务 时 必看)

详 `/Users/bluesurfire/Documents/claude/aimeeting/REQUIREMENTS.md` § 10. 关键 20 个 表:
