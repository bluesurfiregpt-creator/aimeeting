...
| **v26.3** ★ | **召集人模式 · 全 AI 自主会议**(本里程碑) | 2026.05.13 |

更多里程碑细节见 [docs/v26.3-spec.md](docs/v26.3-spec.md)。
