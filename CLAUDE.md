...
### Kimi 测试用例 模板(参考 `/Users/bluesurfire/Documents/claude/aimeeting/docs/kimi-tests/v26.3-05-kimi.md`)
...
4. **给 PM 喂 Kimi 的 prompt** 同样规则 — 不允许 写 `/Users/bluesurfire/Documents/claude/aimeeting/docs/...` 这种 cwd-依赖.

详见 `/Users/bluesurfire/Documents/claude/aimeeting/docs/NORTH_STAR.md` § 8.6.
...
详见 `/Users/bluesurfire/Documents/claude/aimeeting/docs/NORTH_STAR.md` § 8.8 (后续 升级 v1.2.4 写入).
...
1. **读 `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/system/DESIGN_SYSTEM.md` 当前最新版**(如果存在)
...
- subagent 委派 prompt 必须 reference `/Users/bluesurfire/Documents/claude/aimeeting/docs/design/system/DESIGN_SYSTEM.md`
