...
> **写于**: 2026-05-28
> **truth source**: `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/docs/NORTH_STAR.md` v1.2.4 (813 行, 产品宪法), 跟代码不一致时 **以 NORTH_STAR 为准**.
...
### 6.1 Web (`https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/frontend/src/app/`)
...
### 6.2 Mobile (`https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/frontend/src/app/m/`)
...
- **Workstation 走 W_TOKENS** (双 theme dark default + light, `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/frontend/src/components/web/tokens.ts`)
- **会议室走 MR_TOKENS** (双 theme light default + dark, § 7.1.1, `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/frontend/src/components/web/meeting-room/tokens.ts`)
- **Mobile 走 MR_COLORS** (单 theme 浅色 iOS, `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/frontend/src/components/mobile/meeting-room/styles.ts`)
...
> 见 `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/backend/app/models.py` 完整定义. 这里列 Codex 改 业务 时 必看 的 20 个核心表.
...
- `https://github.com/bluesurfiregpt-creator/aimeeting/blob/main/wechat-miniprogram/` 小程序 浅色化 ship 但 Phase B/C 新功能 (NEW-A/B/C) 都 没 mobile 端 (除 NEW-C `/m/chat`), 也 没 小程序端
